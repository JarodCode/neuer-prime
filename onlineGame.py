...
#######################################################################
#### - This file represent the online game, with the leaderboard - ####
#######################################################################
...
def main():
    ...
    while GAMEOVERLOOP:
        ...
        # Calculate the size of the text Name
        ...
        x1_name, y1_name = 750, y2_score + 50
        x2_name = x1_name + player_text_width + 50
        y2_name = y1_name + player_text_height + 40

        # Display name (Orange rectangle, white outline)

        cv2.rectangle(gameover, (x1_name, y1_name -10 ), (x2_name, y2_name), (0, 165, 255), -1)
        cv2.rectangle(gameover, (x1_name, y1_name -10 ), (x2_name, y2_name), (255, 255, 255), 4)
        ...
        # if "Enter" is pressed and the name is not empty the close the game and add the player to the leaderboard
        ...
        # if "Backspace" is pressed the removed the last caracter entered if ther is one
